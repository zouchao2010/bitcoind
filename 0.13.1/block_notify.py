...
parser.add_argument('--bitcoin_rpc_host', dest='bitcoin_rpc_host', type=str)
parser.add_argument('--bitcoin_rpc_port', dest='bitcoin_rpc_port', type=int)
parser.add_argument('--bitcoin_rpc_user', dest='bitcoin_rpc_user', type=str)
parser.add_argument('--bitcoin_rpc_password', dest='bitcoin_rpc_password', type=str)
